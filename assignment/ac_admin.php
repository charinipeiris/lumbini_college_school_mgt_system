                                ...
                                <div class='row'>
                                    ...
                                    <div class='center'>
                                        <form action="admin.php" method="POST">
                                            ...
                                            <button type="submit" name="submit_view_user" class="btn btn-blue btn-large btn-wide">Upload</button>
                                        </form>
                                    </div>
                                <hr>
                                ...
                                <div class='row'>
                                    ...
                                    <div class='center'>
                                        <form action="admin.php" method="POST" onsubmit="return confirm('Are you sure you want to delete?')">
                                            ...
                                            <button type="submit" name="submit_user" class="btn btn-red btn-large btn-wide">Upload</button>
                                        </form>
                                    </div>
                                <hr>
                            ...
                            <br>
                                ...
                                <div class='row'>
                                    ...
                                    <div class='center'>
                                        <form action="admin.php" method="POST" onsubmit="return confirm('Are you sure you want to delete?')">
                                            <input type="text" required name="user_s" placeholder="Type username">
                                            <button type="submit" name="submit_company" class="btn btn-red btn-large btn-wide">Upload</button>
                                        </form>
                                    </div>
                                <hr>
                                ...
                                <div class='row'>
                                    ...
                                    <div class='center'>
                                        <form action="admin.php" method="POST" onsubmit="return confirm('Are you sure you want to reset?')">
                                            <input type="text" required name="user_s" placeholder="Type username">
                                            <button type="submit" name="submit_reset" class="btn btn-green btn-large btn-wide">Upload</button>
                                        </form>
                                    </div>
                                <hr>
